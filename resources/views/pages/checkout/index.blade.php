    ...
    <div class="container mx-auto">
        @if(session('cart'))
            <div class="grid grid-cols-2 gap-2">
                <div class="p-5 rounded-lg" x-data="{tab: {{count($addresses) ? $addresses[0]['id'] : -1 }} }">
                    <form action="/checkout" method="post">
                            ...
                            @foreach($addresses as $index => $address)
                                <div class="border mb-3 px-3 py-2">
                                    <label class=" flex flex-row items-center">
                                        <input type="radio" id="address_id" name="address_id" value="{{$address->id}}" class="mr-3" @click="tab = {{$address->id}}" x-model="tab"/>
                                        <ul>
                        ...
                        <div class="border mb-3 px-3 py-2 flex flex-col" @click="tab=-1">

                            <div class="flex flex-row items-center mb-3">

                                <label class="text-xl">
                                    <input type="radio" id="address_id" name="address_id" value="-1" class="mr-3" @click="tab=-1" x-model="tab"/>
                                    Add address</label>
