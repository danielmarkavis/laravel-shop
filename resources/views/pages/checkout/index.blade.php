                ...
                <div class="p-5 rounded-lg">
                    <form action="/checkout" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input value="john" type="text" id="first_name" name="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input value="wick" type="text" id="last_name" name="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input value="07666766766" type="tel" id="phone_number" name="phone_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            @if($errors->has('phone_number'))
                                <div class="text-red-500">{{ $errors->first('phone_number') }}</div>
                            @endif
                        </div>

                        <h2 class="text-xl mb-3 mt-12">Where should we send it</h2>
                        <fieldset>
                            <legend class="label">
                                <span>Street Address</span>
                            </legend>
                            <div class="mb-2">
                                <input value="The Continental Hotel" type="text" id="street_address_1" name="street_address_1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input value="New York" type="text" id="town" name="town" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            @if($errors->has('town'))
                        ...
                        <div class="mb-2">
                            ...
                            <input value="New York" type="text" id="county" name="county" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        ...
                        <div class="mb-2">
                            <label for="post_code" class="block mb-2 text-sm font-medium text-gray-900">Postcode</label>
                            <input value="NR11 8TE" type="text" id="post_code" name="post_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        ...
                        <div class="mb-2">
                            ...
                            <select name="country" id="country" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                ...
                                <option data-title="United Kingdom" value="GB" selected>United Kingdom</option>
                            </select>
