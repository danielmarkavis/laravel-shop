                        ...
                        <div class="flex flex-col pt-5">
                            <div class="tab-wrapper" x-data="{ activeTab:  0 }">
                                ...
                                <div class="p-5" :class="{ 'active': activeTab === 0 }" x-show.transition.in.opacity.duration.600="activeTab === 0">
                                    <div>
                                        <a href="{{route('payment.store')}}" class="text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50 mr-2 mb-2">
